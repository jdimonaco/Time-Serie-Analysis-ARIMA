...
- The ARIMA (3,1,3) model predicts a warming trend, with the next year's average around 11.05°C, 2.67°C warmer than the current data, and an average temperature of 11.11°C. This consistency across models suggests a continuation of warming trends observed in the dataset. 
